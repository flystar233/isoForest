...
plot_anomaly_projection(model, large_data, sample_rate = NULL)
```
...
4. **Adjust sampling** if needed for speed or detail
   ...
   plot_anomaly_projection(model, data, sample_rate = 0.10)
   
   # More detail (more points)
   plot_anomaly_projection(model, data, sample_rate = 0.02)
   ```
